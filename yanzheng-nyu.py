...
parser.add_argument('--model_dir',type=str,  default='LDRN_NYU_ResNext101_pretrained_data.pkl')
parser.add_argument('--trainfile_kitti', type=str, default = "")
parser.add_argument('--testfile_kitti', type=str, default = "")
parser.add_argument('--trainfile_nyu', type=str, default = "")
parser.add_argument('--testfile_nyu', type=str, default = "./datasets/NYU/12.11_NYU_FFilled.txt")
parser.add_argument('--data_path', type=str, default = "H:/nyu-train")
...
parser.add_argument('--max_depth', default=10.0, type=float, metavar='MaxVal', help='max value of depth')
...
if args.dataset == 'NYU':
    errors, error_names = validate(args, val_loader, Model,dataset='NYU')
